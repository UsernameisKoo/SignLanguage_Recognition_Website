...
for file in os.listdir(data_dir):
    if file.endswith(".pickle"):
        with open(os.path.join(data_dir, file), "rb") as f:
            ...
            labels.extend(gesture_data["labels"])
...
# 학습된 모델 저장
with open("voting_cross_validated_gesture_model.p", "wb") as f:
    pickle.dump(voting_model, f)
print("교차 검증을 거친 Voting 앙상블 모델이 'voting_cross_validated_gesture_model.p'에 저장되었습니다.")
